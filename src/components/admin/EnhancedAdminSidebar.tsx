  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { onClick: () => setLocation("/admin/leads/scoring"), label: "Lead Scoring", icon: Target },
        { onClick: () => setLocation("/admin/leads/followup"), label: "Follow-up Tasks", icon: UserCheck },
        { onClick: () => setLocation("/admin/leads/analytics"), label: "Conversion Analytics", icon: TrendingUp },
      ]
    },
    {
